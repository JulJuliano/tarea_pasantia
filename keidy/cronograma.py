...
reportes_pasantias = [
    {
        ...
        'objetivo': 'Formalizar el inicio de las pasantías, reconocer el Departamento Administrativo y observar el flujo inicial de las requisiciones de compra.',
        'entregables': 'Registro de inducción y primer levantamiento del flujo de requisiciones.',
        'observaciones': 'La pasante mostró puntualidad, disposición e interés durante el proceso de inducción, adaptándose satisfactoriamente a las normas y dinámica del Departamento Administrativo.',
        'actividades': [
            ('1', 'Formalización e inducción',
             'Consignar los formatos de inicio, recibir la inducción de la empresa y conocer los lineamientos del Departamento Administrativo.',
             'Formatos institucionales, cuaderno de notas'),
            ('2', 'Recorrido por el área',
             'Reconocer las áreas físicas y los actores que intervienen en el proceso de procura.',
             'Agenda, cuaderno de apuntes'),
            ('3', 'Presentación ante el equipo',
             'Integrarse al equipo de trabajo y conocer las responsabilidades generales del área de compras y logística.',
             'Documentos de presentación'),
            ('4', 'Observación de requisiciones',
             'Observar cómo ingresa y se procesa inicialmente una solicitud de compra.',
             'Formatos de requisición, cuaderno de campo'),
            ('5', 'Registro de situación inicial',
             'Anotar las primeras oportunidades de mejora detectadas en recepción, seguimiento y control de solicitudes.',
             'Libreta de notas')
        ]
    },

    {
        ...
        'objetivo': 'Apoyar la recepción y registro de solicitudes de compra y levantar el flujo secuencial del proceso actual de procura.',
        'entregables': 'Registro de solicitudes y esquema preliminar del flujo actual de procura.',
        'observaciones': 'La pasante cumplió satisfactoriamente con las actividades asignadas, demostrando responsabilidad y orden en la recepción, clasificación y registro de las solicitudes de compra.',
        'actividades': [
...

    {
        ...
        'objetivo': 'Tramitar requisiciones y aplicar una entrevista estructurada al personal para identificar dificultades de seguimiento y aprobación.',
        'entregables': 'Requisiciones tramitadas y guía de entrevista aplicada con respuestas registradas.',
        'observaciones': 'La pasante evidenció iniciativa y buena comunicación durante la tramitación de requisiciones y el contacto con proveedores, realizando adecuadamente la entrevista y el registro de los hallazgos obtenidos.',
        'actividades': [
            ('1', 'Tramitación de requisiciones',
            ...
            ('4', 'Aplicación de entrevista',
             'Aplicar la guía de entrevista estructurada al personal relacionado con compras y administración.',
             'Guía de entrevista'),
            ('5', 'Registro de hallazgos',
             'Anotar las demoras, duplicidades y dificultades de trazabilidad señaladas durante la entrevista.',
             'Cuaderno de campo')
        ]
    },

    {
        ...
        'objetivo': 'Dar seguimiento a órdenes de compra y revisar expedientes históricos para determinar tiempos de respuesta y etapas críticas.',
        'entregables': 'Registro actualizado de órdenes abiertas y tabla de tiempos por fase.',
        'observaciones': 'La pasante realizó de manera organizada el seguimiento de las órdenes de compra y la revisión de expedientes, demostrando capacidad para identificar tiempos de respuesta y etapas críticas del proceso.',
        'actividades': [
            ('1', 'Seguimiento de órdenes abiertas',
            ...
            ('3', 'Actualización de proveedores',
...

    {
        ...
        'observaciones': 'La pasante mostró capacidad de análisis al organizar y jerarquizar las causas asociadas con las demoras del proceso de procura, elaborando correctamente el diagrama de Ishikawa como herramienta de diagnóstico.',
        'actividades': [
            ...
            ('4', 'Diagrama de Ishikawa',
             'Organizar las causas detectadas en categorías relacionadas con procedimiento, documentación, responsabilidades y seguimiento.',
             'Herramienta de diagramación'),
            ('5', 'Jerarquización de causas',
...

    {
        ...
        'objetivo': 'Diseñar el flujo simplificado del proceso de procura, definiendo etapas, responsables y puntos de control.',
        'entregables': 'Flujo simplificado con responsables y puntos de control definidos.',
        'observaciones': 'La pasante desarrolló satisfactoriamente el flujo simplificado del proceso de procura, demostrando comprensión de las etapas, responsabilidades y puntos de control necesarios para mejorar el seguimiento administrativo.',
        'actividades': [
            ('1', 'Seguimiento a cotizaciones',
...

    {
        ...
        'objetivo': 'Diseñar los formatos estandarizados, la matriz de autorización por monto y los indicadores básicos de seguimiento de la procura.',
        'entregables': 'Formatos de solicitud y orden de compra, matriz de autorización e indicadores propuestos.',
        'observaciones': 'La pasante trabajó de forma responsable en el diseño de los formatos y herramientas de control propuestas, manteniendo coherencia entre las necesidades detectadas y las soluciones planteadas para el proceso de procura.',
        'actividades': [
            ('1', 'Apoyo en requisiciones',
             'Procesar solicitudes de compra recibidas durante la semana.',
             'Formatos de requisición'),
            ('2', 'Formato de solicitud de cotización',
             'Diseñar un formato uniforme para requerir cotizaciones a proveedores.',
             'PC, procesador de textos'),
            ('3', 'Formato de orden de compra',
...

    {
        ...
        'objetivo': 'Redactar la propuesta de simplificación administrativa integrando el flujo, los formatos y los mecanismos de control diseñados.',
        'entregables': 'Borrador completo de la propuesta de simplificación administrativa.',
        'observaciones': 'La pasante integró adecuadamente los diferentes componentes de la propuesta, demostrando organización, capacidad de redacción y dominio de la información recopilada durante el desarrollo de las pasantías.',
        'actividades': [
            ('1', 'Seguimiento a órdenes',
...

    {
        ...
        'observaciones': 'La pasante presentó la propuesta para su revisión, recibió las observaciones de manera receptiva e incorporó oportunamente las correcciones y sugerencias pertinentes al documento.',
        'actividades': [
            ('1', 'Cierre administrativo',
             'Apoyar la organización de expedientes y órdenes correspondientes al período.',
             'Archiveros'),
            ('2', 'Archivo de órdenes',
             'Organizar las órdenes de compra gestionadas durante las pasantías.',
             'Carpetas físicas'),
            ('3', 'Presentación al tutor',
...

    {
        ...
        'objetivo': 'Presentar la propuesta y consolidar el informe académico de pasantías para su entrega institucional.',
        'entregables': 'Propuesta presentada, recaudos de cierre e informe académico final.',
        'observaciones': 'La pasante culminó satisfactoriamente el período de pasantías, demostrando responsabilidad, puntualidad, disposición para recibir sugerencias y cumplimiento de las actividades programadas. Se evidenció una evolución favorable en el manejo de los procesos administrativos y de procura.',
        'actividades': [
            ...
            ('4', 'Revisión normativa',
             ...
             'Normativa IUTECP'),
            ('5', 'Preparación de entrega',
             'Organizar la versión digital para su consignación institucional.',
             'Pendrive, carpeta')
        ]
    }
]
