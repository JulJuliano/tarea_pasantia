...
BASES_TEORICAS = [
    ...
    },
    {
        ...
        "parrafos": [
            ...
            "Desde la perspectiva de quien elabora este informe, la elección del proyecto factible como modalidad de investigación responde no solo a un criterio metodológico, sino a una convicción práctica: los problemas administrativos reales requieren soluciones concretas y aplicables, no únicamente diagnósticos descriptivos. El levantamiento de información realizado durante las semanas de pasantía, las entrevistas al personal, el análisis de expedientes históricos y el diseño de los nuevos formatos y flujos de trabajo constituyen evidencia suficiente de la viabilidad de la propuesta en el entorno específico de la empresa. En conjunto, los cinco fundamentos teóricos desarrollados en este capítulo —procura, proceso administrativo, control interno, simplificación administrativa y proyecto factible— conforman el marco conceptual que sustenta y orienta cada decisión tomada en el diseño de la propuesta presentada en este trabajo."
        ],
        "cita_larga": None
    }
]

POST_CITA_TEXTO = "El planteamiento de Monterroso permite comprender que la ineficiencia en la procura de Lubricantes y Equipos Varyna, C.A. no es un problema aislado de demoras puntuales, sino una consecuencia directa de la ausencia de un sistema estructurado de abastecimiento. La propuesta de simplificación administrativa desarrollada en el presente trabajo parte precisamente de este enfoque: antes de simplificar tiempos, es necesario formalizar el proceso."
