...
reportes_pasantias = [
    ...
    # ── SEMANA 5 ────────────────────────────────────────────────
    {
        ...
        "actividades": [
            ...
            ("4", "Pruebas de usabilidad del módulo de consulta", "Ejecución de casos de prueba sobre el módulo de búsqueda utilizando datos reales de expedientes registrados en semanas anteriores, verificando la integridad de los resultados.", "Datos históricos de la base de datos"),
    ...
    # ── SEMANA 6 ────────────────────────────────────────────────
    {
        ...
        "actividades": [
            ...
            ("4", "Compilación y prueba del ejecutable", "Generación del archivo ejecutable, prueba de su funcionamiento sobre el equipo corporativo de la oficina y verificación de que todos los módulos responden correctamente sin instalaciones adicionales.", "Equipo corporativo de la oficina, ejecutable compilado"),
    ...
    # ── SEMANA 7 ────────────────────────────────────────────────
    {
        ...
        "actividades": [
            ...
            ("4", "Depuración y corrección de errores detectados", "Análisis de los errores registrados durante las pruebas, corrección en el código fuente y ejecución de pruebas de para confirmar que las correcciones no introducen nuevas fallas.", "Editor de código fuente, repositorio GitHub"),
