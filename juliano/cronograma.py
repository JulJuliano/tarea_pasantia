...
reportes_pasantias = [
    # ── SEMANA 1 ────────────────────────────────────────────────
    {
        ...
        "actividades": [
            ...
            ("2", "Análisis del proceso documental actual", "Observación directa y mapeo del ciclo de vida de los documentos: recepción, registro, derivación y firma. Estudio de las hojas de cálculo vigentes utilizadas para el control.", "Formatos de hojas de cálculo actuales, bitácora de observación"),
    ...
    # ── SEMANA 7 ────────────────────────────────────────────────
    {
        ...
        "actividades": [
            ...
            ("4", "Depuración y corrección de errores detectados", "Análisis de los errores registrados durante las pruebas, corrección en el código fuente y ejecución de pruebas de para confirmar que las correcciones no generan nuevas fallas.\n", "Editor de código fuente, repositorio GitHub"),
